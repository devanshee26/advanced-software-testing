...
// Test case 19
TEST(CategoryPartition_BaseBlockCriteria, TestCase19) {    
    register_signal_handler();
    if (setjmp(jump_buffer) == 0) {
...
// Test case 20
TEST(CategoryPartition_BaseBlockCriteria, TestCase20) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
...
// Test case 21
TEST(CategoryPartition_BaseBlockCriteria, TestCase21) {   
    register_signal_handler(); 
    if (setjmp(jump_buffer) == 0) {
...
// Test case 22
TEST(CategoryPartition_BaseBlockCriteria, TestCase22) { 
    register_signal_handler();   
    if (setjmp(jump_buffer) == 0) {
