...
generate_coverage() {
    ...
    rm -rf ../../CoverageReports/CoverageAnalysis/CP/Base_WithError/Test_${test}/*
    mkdir ../../CoverageReports/CoverageAnalysis/CP/Base_WithError/Test_${test} 
    ...
    gcovr -r . --html --html-details -o "../../CoverageReports/CoverageAnalysis/CP/Base_WithError/Test_${test}/coverage_report.html"
}
