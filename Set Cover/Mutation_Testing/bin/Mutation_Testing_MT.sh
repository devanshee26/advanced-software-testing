...
do
    ...
    rm -rf *.gc* 
    rm -rf coverage_*.*
    g++ -std=c++14 -fprofile-arcs -ftest-coverage -o ../executables_mt/SetCover_Mutation_Exec_$i ../mutations_CodeOnly/SetCover_CodeOnly.mutant.$i.c ../../SetCover_Mutation_TestSuite/SetCover_Mutation_MetamorphicPassedTests.cpp $(pkg-config --cflags --libs gtest) -pthread

    "../executables_mt/SetCover_Mutation_Exec_$i" &
    if [ -f "../executables_mt/SetCover_Mutation_Exec_$i" ]; then
        ...
        if ps -p $pid > /dev/null; then
            ...
            "../executables_mt/SetCover_Mutation_Exec_$i" > /dev/null 2>&1
            if [ $? -eq 0 ]; then
                echo "Mutation $i is killed\n"
            else
            ...
            "../executables_mt/SetCover_Mutation_Exec_$i" > "../outputs_mt/Output_Mutation_$i.txt"
